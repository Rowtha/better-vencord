...
import AdacordToolboxPlugin from "@plugins/adacordToolbox";
...
const settings = definePluginSettings({
    ...
    location: {
        ...
        options: [
            ...
            { label: "Adacord Toolbox", value: "TOOLBOX" }
        ],
        get hidden() {
            return !isPluginEnabled(AdacordToolboxPlugin.name);
        }
    }
});
...
function GameActivityToggleButton(props: { nameplate?: any; }) {
    ...
    if (location !== "PANEL" && isPluginEnabled(AdacordToolboxPlugin.name)) return null;
