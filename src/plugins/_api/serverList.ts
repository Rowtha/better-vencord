    ...
    patches: [
        {
            ...
            replacement: {
                ...
                replace: "[$1].concat(Adacord.Api.ServerList.renderAll(Adacord.Api.ServerList.ServerListRenderPosition.Above))"
            }
        },
        {
            find: ".setGuildsTree(",
            replacement: {
                ...
                replace: "Adacord.Api.ServerList.renderAll(Adacord.Api.ServerList.ServerListRenderPosition.In).concat($&)"
            }
        }
    ]
});
