    ...
    return (
        <section>
            ...
            <Paragraph size="md" className={Margins.bottom20}>
                Adacord comes with a cloud integration that adds goodies like settings sync across devices.
                It <Link href="https://github.com/Rowtha/adacord">respects your privacy</Link>, and
                the <Link href="https://github.com/Adacord/Backend">source code</Link> is AGPL 3.0 licensed so you
        ...
        <section>
            ...
            <Flex flexDirection="column" gap="1em">
                <FormSwitch
                    ...
                    description="Save your Adacord settings to the cloud so you can easily keep them the same on all your devices"
